...
import { PRESET_SCENARIOS, PresetScenario, ScenarioCategory } from '../../utils/scenarios';
      ...
      try {
        ...
        if (data.status === 'SUCCESS' || data.result?.status === 'COMPLETED') {
          ...
          setMetrics({
            ...
            metric_tonnes: result.metric_tonnes,
            thickness_microns: result.thickness_microns,
